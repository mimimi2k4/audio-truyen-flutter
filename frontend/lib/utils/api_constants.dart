import 'package:flutter/foundation.dart'; // [Quan trọng] Import để dùng biến kIsWeb

class ApiConstants {
  // Tự động kiểm tra: Nếu đang chạy Web (kIsWeb = true) thì dùng localhost
  // Ngược lại (App Mobile) thì dùng 10.0.2.2 cho Android Emulator
